...
namespace WebApplication5.Model
{
    public class SendPacket
    {
        ...
        public byte downlink_att { get; set; } 
        ...
        public byte uplink_gain { get; set; }
        ...
        public byte self_tester_att { get; set; }
        ...
        public UInt16 calculateChecksum()
        {
            return (UInt16)(testmode + couple + ATT_Value + frequency + selftest+
                 ...
                 m2xm + m2ym + m2zm + m2status + m2adm + downlink_data_mode2+ cfar_coef+
                 m3xm + m3ym + m3zm + m3status + m3adm + downlink_data_mode3+
                 m4xm + m4ym + m4zm + m4status + m4adm + downlink_data_mode4+ downlink_att+
                 m5xm + m5ym + m5zm + m5status + m5adm + downlink_data_mode5+ uplink_gain+
                 m6xm + m6ym + m6zm + m6status + m6adm + downlink_data_mode6+ self_tester_att);
